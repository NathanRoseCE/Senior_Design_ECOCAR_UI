...
"""autogenerated by genpy from erau_fusion_msgs/unfused_vehicles.msg. Do not edit."""
import codecs
import sys
...
class unfused_vehicles(genpy.Message):
  _md5sum = "684bc5fc33bc46adb1a1a5655fe0e25f"
  _type = "erau_fusion_msgs/unfused_vehicles"
...
"""
  ...
  _slot_types = ['std_msgs/Header','erau_fusion_msgs/veh_object[32]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(unfused_vehicles, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.objects is None:
        self.objects = [erau_fusion_msgs.msg.veh_object() for _ in range(32)]
    else:
      self.header = std_msgs.msg.Header()
      self.objects = [erau_fusion_msgs.msg.veh_object() for _ in range(32)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.objects = []
      for i in range(0, 32):
        val1 = erau_fusion_msgs.msg.veh_object()
        _x = val1
        start = end
        end += 42
