...
class tracked_vehicles {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new Array(32).fill(new tracked_veh_object());
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.objects.forEach((val) => {
      bufferOffset = tracked_veh_object.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new tracked_vehicles(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = tracked_veh_object.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new tracked_vehicles(null);
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        if (msg.objects.length > i) {
          resolved.objects[i] = tracked_veh_object.Resolve(msg.objects[i]);
        }
        else {
          resolved.objects[i] = new tracked_veh_object();
        }
      }
    }
    else {
      resolved.objects = new Array(32).fill(new tracked_veh_object())
    }
...
module.exports = tracked_vehicles;
