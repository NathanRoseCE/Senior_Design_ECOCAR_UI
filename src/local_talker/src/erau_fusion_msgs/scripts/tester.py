...
class SimulateData:
    ...
    def runCarPassing(self):
        obstacle = Obstacle(0, 0, -10, 0, 0, 1.0, 2.0, blinkerInfo.BLINKER_INFO_OFF, classification.CAR, LanePosition.LEFT)
    ...
    def runCarChangeLane(self):
        ...
        obstacle = Obstacle(1, 0, -5, 0, 0, 1.0, 2.0, blinkerInfo.BLINKER_INFO_LEFT, classification.CAR, LanePosition.CENTER)
        ...
        for i in range(30):
			...
			time.sleep(0.1)
        #end for
        obstacle.lane = LanePosition.RIGHT
        obstacle.x = -1.5
        ...
        for i in range(30):
			...
			time.sleep(0.1)
        #end for
        obstacle.lane = LanePosition.CENTER
        obstacle.x = 1.5
